...
class QRcode {
    ...
    //----------------------------------------------------------------------
    public static function png($text, $outfile = false, $level = Constants::QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint = false, $qrFillColor = Constants::QR_FILL_COLOR_DEFAULT, $qrPixelColor = Constants::QR_PIXEL_COLOR_DEFAULT)
    {
        $enc = QRencode::factory($level, $size, $margin);
        return $enc->encodePNG($text, $outfile, $saveandprint, $qrFillColor, $qrPixelColor);
    }
